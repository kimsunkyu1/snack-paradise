...
<?
	...
	$query = "select name14 from opt where no14 = $no1;";
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
	<tr height="50">
		<td align="left"  width="300" valign="bottom">&nbsp 옵션명 : <font color="#0457A2"><b><?=$row['name14']?></b></font></td>
...
<table width="500" border="1" cellpadding="2" style="border-collapse:collapse">
	...
	<?
		$query = "select * from opts where opt_no14 = $no1;";
		$result = mysqli_query($db,$query);
		if(!$result) exit("에러:$query");
		...
		for($i=0; $i<$count; $i++)
		{
			...
			echo("<tr bgcolor='#F2F2F2' height='20'>	
				...
				<td width='300' align='left'>$row[name14]</td>
				<td width='100' align='center'>
					<a href='opts_edit.php?no1=$row[opt_no14]&no2=$row[no14]'>수정</a>/
					<a href='opts_delete.php?no1=$row[opt_no14]&no2=$row[no14]' onclick='javascript:return confirm(\"삭제할까요 ?\");'>삭제</a>
				</td>
			</tr>");
		}
	?>
