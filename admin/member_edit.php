...
<?
	$query = "select * from member where no14 = $no;";
	...
	$birthday1 = trim(substr($row['birthday14'],0,4));
	$birthday2 = trim(substr($row['birthday14'],5,2));
	$birthday3 = trim(substr($row['birthday14'],8,2));
?>
...
<table width="600" border="1" cellpadding="2"  style="border-collapse:collapse">
	...
	<tr height="20"> 
		...
		<?echo("<td width='500' bgcolor='#F2F2F2'>$row[uid14]</td>");?>
	</tr>
