...
<!-------------------------------------------------------------------------------------------->	
				...
				for($i=1;$i<=$n_cart;$i++)
				{
					if($cart[$i])
					{
						...
						else
						{
							...
							$toprice = number_format($price1*$num);
							$toprice1 = $price*$num;
						}*/
						if($row['discount14']==0)
						{
			...
			<input type="hidden" name="r_tel1"    value="<?=$o_tel1?>">
			<input type="hidden" name="r_tel2"    value="<?=$o_tel2?>">
			<input type="hidden" name="r_tel3"    value="<?=$o_tel3?>">
			<input type="hidden" name="r_phone1"  value="<?=$o_phone1?>">
			<input type="hidden" name="r_phone2"  value="<?=$o_phone2?>">
			<input type="hidden" name="r_phone3"  value="<?=$o_phone3?>">
