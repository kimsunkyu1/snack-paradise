...
<?
	...
	if (!$text1)
	$query="select * from juso order by name14;";
	else
	$query="select * from juso where name14 like '%$text1%' order by name14;";
	...
	for($i=0;$i<$page_last;$i++)
	{
		...
		echo("
			 ...
			 <td width='50'  align='center'>&nbsp <a href='juso_edit.php?no=$row[no14]'>$row[name14]</a></td>
			 <td width='200' align='center'>&nbsp $tel</td>
			 <td width='50'  align='center'>&nbsp $sm</td>
			 <td width='200'  align='center'>&nbsp $row[birthday14]</td>
			 <td width='450'  align='center'>&nbsp $row[juso14]</td>

			 <td align='center'>
				<a href='juso_delete.php?no=$row[no14]'
